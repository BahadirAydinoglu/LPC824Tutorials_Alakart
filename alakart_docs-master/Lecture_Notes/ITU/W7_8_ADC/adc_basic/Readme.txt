...
The "adc_basic" project demonstrates a simple initialization and use of the ADC. Conversion is started by the software directly. The software blocks (stops all further execution) until the ADC conversion is complete.
...
* Convert several specified ADC channels after one trigger.
  - There are two "sequence regsters": Sequence A and Sequence B.
